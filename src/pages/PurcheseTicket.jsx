...
const PurcheseTicket = () => {
  ...
  const handlePuchaseTickets = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_running_server}/purchase-ticket`, newOrder)
      .then((res) => {
    ...
    <div className="w-11/12 mx-auto pt-28">
      ...
      <div className="flex justify-center mt-10">
        <div className="w-full lg:w-[650px] px-6 py-12 border">
          <h3 className="text-center text-gray-700 font-bold pb-3 text-2xl">
            Ticket Reservation Form
          </h3>
          {errMsg && (
            <p className="text-red-600 text-center font-medium">{errMsg}</p>
          )}
          <form onSubmit={handlePuchaseTickets}>
            <div className="flex flex-col mt-6">
              ...
              <input
                className="border mt-1 px-3 py-2.5 font-semibold border-none outline-none bg-gray-100 text-gray-700"
                type="text"
                name="name"
                id=""
              />
            ...
            <button
              type="submit"
              className="btn bg-orange-500 w-full mt-8 text-white hover:text-gray-700"
            >
              Confirm Pruchase
            </button>
          </form>

...
const VipMembership = () => {
    return (
        <div>
            ...
            <div style={{backgroundImage: `url(${vipMembership})`, backgroundSize: '100% 400px', backgroundRepeat: 'no-repeat', backgroundBlendMode: 'hue' }} className='relative flex justify-center items-center w-full h-[250px] md:h-[400px] bg-[#000000bd]'>
                <div className='absolute justify-center'>
                    <h3 className='text-3xl md:text-5xl font-bold text-slate-100'>Get <span className='text-orange-500'>20%</span> Discount</h3>
                    <h2 className='text-slate-100 font-bold mt-14 text-2xl md:text-4xl text-center'>Vip Membership</h2>
                </div>
            </div>
            <div className='mt-10'>
                    
                    <p className='text-center mt-4 text-4xl font-semi font-bold text-gray-700 leading-relaxed'>VIP Circus Experience</p>
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-5 mt-8'>
                        {/* vip card 1 */}
                        <div className="px-3.5 fullMagicCards">
                            <div className="relative">
                                <img className="h-[350px] md:h-[400px] lg:h-[450px]" src={vipCircus4} alt="" />
                        ...
                        <div className="px-3.5 fullMagicCards">
                            <div className="relative">
                                <img className="h-[350px] md:h-[400px] lg:h-[450px]" src={vipCircus2} alt="" />
                                <div className="absolute bg-[#0000009f] py-5 bottom-0 w-full h-full text-white text-left pl-5">
                                <div>
                                    <p className='bg-yellow-600 inline px-7 py-2 font-semibold'>Vip</p>
                                </div>
                        ...
                        <div className="px-3.5 fullMagicCards">
                            <div className="relative">
                                <img className="h-[350px] md:h-[400px] lg:h-[450px]" src={vipCircus3} alt="" />
                                <div className="absolute bg-[#0000009f] py-5 bottom-0 w-full h-full text-white text-left pl-5">
                                <div>
                                    <p className='bg-yellow-600 inline px-7 py-2 font-semibold'>Vip</p>
                                </div>
